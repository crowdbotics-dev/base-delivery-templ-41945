...
## Project Structure
    ...
    ├── base_delivery_templ_41945  # Django project configurations
...
1. Clone this repo and `cd base_delivery_templ_41945`
...
2. Clone this repo and `cd base_delivery_templ_41945`
